    ...
    <main className="px-5 sm:px-6 md:px-8 lg:px-10 py-10 max-w-3xl mx-auto leading-8 text-[17px] text-slate-800">
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          meaningful—shared values, respect, curiosity—your confidence will glow
          naturally.
        </p>
        <p>
          A healthy why sounds like this:{" "}
          <strong>
            “I want a partner who respects me, shares my values, appreciates my
            Nigerian identity, and is open to learning across cultures.”
          </strong>
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          intention. Photos should tell a story: 1 clean headshot, 1 full‑body,
          2 lifestyle, 1 social. Smile like NEPA didn’t catch you today. Warmth
          converts.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>“You like hiking? Drop your top 3 beginner‑friendly trails.”</li>
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">Communication: Direct but Gentle</h2>
        <p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          vibe: “I love how thoughtful your messages are,” “You have a peaceful
          energy.” In person, let your eyes and smile do quiet work. Touch only
          with consent and context.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Food market/fair:</strong> Share bites, swap stories, banter
            everywhere.
          </li>
          <li>
            <strong>Cook‑together (2nd/3rd date):</strong> Introduce plantain or
            jollof—keep it light.
          </li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          Invite them gently: share a song (Asa, Johnny Drille, The Cavemen), a
          movie (fun like “The Wedding Party” or thoughtful like “Citation”),
          and a story (grandma’s wisdom, your Sunday routine). Ask for theirs
          too. Mutual curiosity is romantic.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          By date two or three, cover the big rocks: faith stance, relationship
          goals, kids or no kids, openness to relocation, money styles. Keep it
          soft and curious: “Faith anchors me; Sundays matter— how does
          spirituality show up for you?”
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          leaves because you set standards, let them. It’s misalignment leaving,
          not love.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          Talk money early—but respectfully. Who pays for what on dates? How do
          you both view gifts, vacations, and savings? Don’t assume Oyinbo =
        ...
        <p>
          If one partner earns in a stronger currency, address how that affects
          shared experiences without breeding entitlement or resentment. Be
          generous, be fair, and communicate.
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          gifts, conversational norms. Teach your partner how to pronounce names
          and when to say “Good morning sir/ma.” In return, learn how their
          family does things—first‑name basis? shoes off indoors? Bring a small,
          thoughtful gift on first visits (coffee beans, tea, a local snack, or
          a mini photo book of places you love in Nigeria).
        </p>
      </section>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>Pressure to relocate/marry instantly without proper process.</li>
        </ul>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p>
          Sustainable love is built from rituals (morning texts, Sunday calls),
          repair (apologise well, forgive wisely), and planning (shared goals,
          travel calendars, growth habits). Keep curiosity alive: learn each
          other’s foods, languages, and histories. Celebrate small wins,
          document memories, and anchor the relationship in service—how do we
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold">
          Common Challenges in Nigerian–Oyinbo Relationships (and How to Handle
          Them Like a Pro)
        </h2>
        <p>
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Expectations in dating timelines:</strong> Nigerians may see
            dating as intentional and short road to marriage. Some Oyinbo
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          You don’t need to dilute your accent, avoid your food, or “tone down”
          your energy to be accepted. A partner who genuinely loves you will be
          curious about your world.
        </p>
        <p>Keep your identity alive intentionally:</p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
            Teach them a few phrases in your language (start with greetings and
            sweet compliments).
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <p>
          You want to show them the beauty of Nigeria—but don’t drop them into a
          cultural “masterclass” on day one. Culture is best enjoyed like
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Invite, don’t force:</strong> “Would you like to try suya?”
            works better than “If you don’t eat spicy food, we can’t date.”
          </li>
        </ul>
        <p>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          <em>you</em>. Some people want the “exotic experience” or the “African
          fantasy.” You’re not an experiment, a checkbox, or a storyline for
          their friends. You’re a human being with depth.
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>
          ...
          <li>
            <strong>Test for real curiosity:</strong> Do they learn about you at
            a soul level or surface level?
          </li>
        </ul>
        <p>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Learn theirs too</strong> so you don’t misinterpret honesty
            as disrespect.
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            <strong>Don’t make love a debate topic:</strong> You’re not here to
            convince the world—just to love well.
          </li>
        </ul>
        <p>
          Your relationship is between the two of you—others are spectators, not
          decision-makers.
        </p>
      </section>
